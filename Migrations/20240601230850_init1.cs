    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WindParks", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAndTimeAddedToDelete = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    WindParkId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Windmills", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_Windmills_WindParks_WindParkId",
                        column: x => x.WindParkId,
                        principalTable: "WindParks",
